...
class TestHelpFfmpegImports:
    ...
    def test_runffmpeg(self):
        from phiendichvideo.util.help_ffmpeg import runffmpeg
        assert callable(runffmpeg)

    def test_extract_concise_error(self):
        from phiendichvideo.util.help_ffmpeg import extract_concise_error
        assert callable(extract_concise_error)

    def test_get_filepath_from_cmd(self):
        from phiendichvideo.util.help_ffmpeg import get_filepath_from_cmd
        assert callable(get_filepath_from_cmd)

    def test_runffprobe(self):
        from phiendichvideo.util.help_ffmpeg import runffprobe
        assert callable(runffprobe)

    def test_get_video_info(self):
        from phiendichvideo.util.help_ffmpeg import get_video_info
        assert callable(get_video_info)

    def test_get_video_duration(self):
        from phiendichvideo.util.help_ffmpeg import get_video_duration
        assert callable(get_video_duration)

    def test_get_audio_time(self):
        from phiendichvideo.util.help_ffmpeg import get_audio_time
        assert callable(get_audio_time)

    def test_get_video_ms_noaudio(self):
        from phiendichvideo.util.help_ffmpeg import get_video_ms_noaudio
        assert callable(get_video_ms_noaudio)

    def test_conver_to_16k(self):
        from phiendichvideo.util.help_ffmpeg import conver_to_16k
        assert callable(conver_to_16k)

    def test_create_concat_txt(self):
        from phiendichvideo.util.help_ffmpeg import create_concat_txt
        assert callable(create_concat_txt)

    def test_concat_multi_audio(self):
        from phiendichvideo.util.help_ffmpeg import concat_multi_audio
        assert callable(concat_multi_audio)

    def test_change_speed_rubberband(self):
        from phiendichvideo.util.help_ffmpeg import change_speed_rubberband
        assert callable(change_speed_rubberband)

    def test_precise_speed_up_audio(self):
        from phiendichvideo.util.help_ffmpeg import precise_speed_up_audio
        assert callable(precise_speed_up_audio)

    def test_cut_from_audio(self):
        from phiendichvideo.util.help_ffmpeg import cut_from_audio
        assert callable(cut_from_audio)

    def test_remove_silence_wav(self):
        from phiendichvideo.util.help_ffmpeg import remove_silence_wav
        assert callable(remove_silence_wav)

    def test_check_hw_on_start(self):
        from phiendichvideo.util.help_ffmpeg import check_hw_on_start
        assert callable(check_hw_on_start)

    def test_get_video_codec(self):
        from phiendichvideo.util.help_ffmpeg import get_video_codec
        assert callable(get_video_codec)

    def test_send_notification(self):
        from phiendichvideo.util.help_ffmpeg import send_notification
        assert callable(send_notification)

    def test_format_video(self):
        from phiendichvideo.util.help_ffmpeg import format_video
        assert callable(format_video)

    def test_all_names_importable(self):
        from phiendichvideo.util import help_ffmpeg
        expected = [
