...
from phiendichvideo.configure.excepts import NO_RETRY_EXCEPT, TranslateSrtError, LLMSegmentError, StopTask
from phiendichvideo.configure.config import logger, settings, params, ROOT_DIR, tr
...
class OpenAICampat(BaseTrans):
    ...
    def llm_segment(self, srt_list,step='')->List[SrtItem]:
        ...
        prompts_template = Path(f'{ROOT_DIR}/phiendichvideo/prompts/resegment/llm{step}.txt').read_text(encoding='utf-8')
