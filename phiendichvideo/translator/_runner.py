...
from phiendichvideo.configure.config import app_cfg, logger
from phiendichvideo.translator._base import BaseTrans
from phiendichvideo import get_class
...
from phiendichvideo.translator._lang_utils import get_source_target_code
...
def run(*, translate_type=0,
    ...
    if translate_type == GOOGLE_INDEX:
        if app_cfg.proxy or _check_google() is True:
            from phiendichvideo.translator._google import Google
