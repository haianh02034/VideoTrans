...
from phiendichvideo.configure.config import tr, settings, logger, TEMP_ROOT
from phiendichvideo.task.taskcfg import SrtItem
from phiendichvideo.util.help_srt import get_subtitle_from_srt,cleartext
from phiendichvideo.util.help_misc import get_md5,serial
...
class BaseTrans(BaseCon):
    ...
    def _run_text(self, split_source_text: List[List[str]]):
        ...
        if _empty_line >= len(self.text_list):
            from phiendichvideo.configure.excepts import TranslateSrtError
