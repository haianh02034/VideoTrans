...
from phiendichvideo.configure.config import tr, settings, app_cfg, logger, HOME_DIR
from phiendichvideo.task._base import BaseTask
from phiendichvideo.task.taskcfg import TaskCfgTTS, SrtItem
import asyncio
...
class DubbingSrt(BaseTask):
    ...
    def _tts(self) -> None:
        ...
        if _enter_edgetts_single:
            ...
            from phiendichvideo.util.help_role import get_edge_rolelist
        ...
        for i, it in enumerate(subs):
            ...
            from phiendichvideo.util.help_misc import get_md5
            _key = get_md5(
        ...
        if not queue_tts or len(queue_tts) < 1:
            from phiendichvideo.configure.excepts import DubbingSrtError
    ...
    def align(self) -> None:
        ...
        from phiendichvideo.task._rate import TtsSpeedRate
    ...
    def task_done(self):
        ...
        from phiendichvideo.util.help_ffmpeg import runffmpeg, remove_silence_wav
