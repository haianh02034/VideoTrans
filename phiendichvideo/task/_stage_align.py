...
from phiendichvideo.configure.config import tr, logger
from phiendichvideo.tts import EDGE_TTS, AZURE_TTS
from phiendichvideo.util.help_ffmpeg import get_video_duration, runffmpeg
from phiendichvideo.util.help_misc import vail_file, is_novoice_mp4
from phiendichvideo.util.help_srt import ms_to_time_string, delete_punc
...
class AlignMixin:
    ...
    def align(self) -> None:
        ...
        from phiendichvideo.task._rate import SpeedRate
        rate_inst = SpeedRate(
