...
class TaskCfgVTT(TaskCfgSTT, TaskCfgTTS, TaskCfgSTS):
    ...
    def __repr__(self):
        _msg=[]
        from phiendichvideo.recognition import ALLOW_CHANGE_MODEL
        from phiendichvideo.util.tools import get_recogn_type,get_tanslate_type,get_tts_type
        from phiendichvideo.configure.config import tr,settings
