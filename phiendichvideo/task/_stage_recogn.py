...
from phiendichvideo.configure.config import tr, ROOT_DIR, settings, logger
from phiendichvideo.configure.excepts import SpeechToTextError
from phiendichvideo.recognition import run as run_recogn, is_allow_lang as recogn_allow_lang, FASTER_WHISPER
from phiendichvideo.util.help_ffmpeg import conver_to_16k, runffmpeg, cut_from_audio
from phiendichvideo.util.help_misc import vail_file
from phiendichvideo.util.help_srt import get_subtitle_from_srt, delete_punc
