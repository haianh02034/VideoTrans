...
from phiendichvideo.configure.config import ROOT_DIR, tr, defaulelang

JSON_FILE = f'{ROOT_DIR}/phiendichvideo/ass.json'
PREVIEW_IMAGE = f'{ROOT_DIR}/phiendichvideo/styles/preview.png'
