...
from phiendichvideo.configure._paths import ROOT_DIR
from phiendichvideo.configure._logging import _write_with_retry
from phiendichvideo.configure.contants import (
...
class AppParams:
    ...
    """
    _json_path: str = f"{ROOT_DIR}/phiendichvideo/params.json"
