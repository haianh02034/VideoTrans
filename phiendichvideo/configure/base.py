...
from phiendichvideo.configure.config import tr, settings, app_cfg, logger, push_queue, TEMP_ROOT





from phiendichvideo.util.help_misc import set_proxy,vail_file
...
class BaseCon:
    ...
    def _new_process(self, callback=None, title="", is_cuda=False, kwargs=None):
        ...
        from phiendichvideo.process.signelobj import GlobalProcessManager
        kwargs = kwargs or {}
        ...
        try:
            ...
            if is_cuda:
                ...
                if settings.get('multi_gpus'):
                    from phiendichvideo.util.gpus import get_cudaX
