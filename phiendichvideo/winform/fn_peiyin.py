...
def openwin():
    ...
    from phiendichvideo.configure.contants import LISTEN_TEXT
    import re
    import json
    ...
    from phiendichvideo.configure.config import tr, app_cfg, params, defaulelang,   HOME_DIR
    from phiendichvideo.configure import config
    from phiendichvideo.task.taskcfg import TaskCfgTTS
    from phiendichvideo import translator, tts
    from phiendichvideo.component.set_form import Peiyinform
    ...
    def _bind():
        from phiendichvideo.component.component import PeiyinDropButton
