...
def openwin():
    ...
    from phiendichvideo.configure.config import tr, app_cfg, settings, params, logger, HOME_DIR
    from phiendichvideo.configure import config
    from phiendichvideo.util import tools

    RESULT_DIR = HOME_DIR + "/vas"

    from phiendichvideo.translator import LANGNAME_DICT, get_subtitle_code
    ...
    from phiendichvideo.component.set_form import VASForm
