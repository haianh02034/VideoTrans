...
def openwin():
    ...
    from phiendichvideo.util.help_misc import hide_show_element, show_error
    from typing import List
    from phiendichvideo.task.taskcfg import InputFile
    import sys
    import json
    ...
    from phiendichvideo.configure.config import tr, app_cfg, settings, params, HOME_DIR
    from phiendichvideo.configure import config
    from phiendichvideo.task.taskcfg import TaskCfgSTT
    from phiendichvideo import translator, recognition
    from phiendichvideo.component.set_form import Recognform
    ...
    def shibie_start_fun():
        ...
        if winobj.rephrase.currentIndex() == 1:
            ...
            if ai_type in ['openai','chatgpt'] and not params.get('chatgpt_key'):
                ...
                from phiendichvideo.winform import chatgpt
                chatgpt.openwin()
                return
            if ai_type == 'deepseek' and not params.get('deepseek_key'):
                show_error(tr('llmduanjudp'))
                from phiendichvideo.winform import deepseek
                deepseek.openwin()
                return
        ...
        try:
            ...
            from phiendichvideo.task.child_win_sign import SignThread
    ...
    def show_cpp_select():
        ...
        if not cpp_path or not Path(cpp_path).exists():
            from phiendichvideo.component.set_cpp import SetWhisperCPP
    ...
    def _bind():
        from phiendichvideo.component.component import DropButton
