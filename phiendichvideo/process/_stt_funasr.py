...
from phiendichvideo.configure.config import logger, ROOT_DIR
from phiendichvideo.process._stt_utils import _write_log, _remove_unwanted_characters
    ...
    try:
        ...
        if model_name == 'iic/SenseVoiceSmall':
            ...
            model = AutoModel(
                ...
                remote_code=f"{ROOT_DIR}/phiendichvideo/codes/model.py",
                hub='ms',
            )
