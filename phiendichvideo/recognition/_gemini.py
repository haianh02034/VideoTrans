...
from phiendichvideo.configure.excepts import NO_RETRY_EXCEPT, StopRetry, SpeechToTextError,StopTask
from phiendichvideo.configure.config import params, logger, ROOT_DIR, settings,tr
...
class GeminiRecogn(BaseRecogn):
    ...
    def _exec(self)->Union[List[SrtItem], None]:
        ...
        prompt = Path(ROOT_DIR+'/phiendichvideo/prompts/recogn/gemini_recogn.txt').read_text(encoding='utf-8')
        # 保存说话人
        speaker_list=[]
