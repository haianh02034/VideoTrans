...
from phiendichvideo.configure.excepts import NO_RETRY_EXCEPT, StopRetry
from phiendichvideo.configure.config import tr, params, settings,  logger, ROOT_DIR
...
def _get_camb_lang_id(langcode):
    ...
    cache_file = Path(ROOT_DIR + '/phiendichvideo/voicejson/camb_languages.json')
...
class CambRecogn(BaseRecogn):
    ...
    def _exec(self) -> Union[List[SrtItem], None]:
        ...
        if not lang_id:
            ...
            from phiendichvideo.translator._camb import refresh_camb_languages
