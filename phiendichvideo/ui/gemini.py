...
from phiendichvideo.configure.config import tr,ROOT_DIR, params,settings
from phiendichvideo.configure.contants import GEMINI_TTS_MODELS
...
class Ui_geminiform(object):
    def setupUi(self, geminiform):
        ...
        self.gemini_srtprompt.setText(f'{ROOT_DIR}/phiendichvideo/prompts/recogn/gemini_recogn.txt')
