...
config.init_run()
from phiendichvideo.configure.config import tr, params, settings, app_cfg, logger, ROOT_DIR
from phiendichvideo import VERSION
from phiendichvideo.util.checkgpu import AiLoaderThread
from phiendichvideo.ui.en import Ui_MainWindow
from phiendichvideo.task.simple_runnable_qt import run_in_threadpool
...
class MainWindow(BindSignalsMixin, WinformMixin, LifecycleMixin, QMainWindow, Ui_MainWindow):
    ...
    def _set_default(self):
        ...
        from phiendichvideo.translator import TRANSLASTE_NAME_LIST,LANGNAME_DICT,get_code
        ...
        from phiendichvideo.util.help_misc import set_proxy
    ...
    def _daemon(self):
        ...
        from phiendichvideo.util.help_misc import check_new_version, is_connect_hf
        check_hw_on_start()
        check_new_version()
        is_connect_hf()
    ...
    def _start_workers(self, status):
        if status == 'end':
            from phiendichvideo.task.job import start_thread
