...
from phiendichvideo.configure.config import tr, app_cfg
from phiendichvideo.configure import contants
from phiendichvideo.configure.contants import LISTEN_TEXT
from phiendichvideo.util.help_misc import open_url, show_error
...
class WinActionBaseMiscMixin:
    ...
    def about(self):
        ...
        from phiendichvideo.component.set_form import InfoForm
        def open():
    ...
    def lawalert(self):
        from phiendichvideo.ui.lawalert import Ui_lawalert
