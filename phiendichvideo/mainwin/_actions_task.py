...
from phiendichvideo.component.progressbar import ClickableProgressBar
from phiendichvideo.configure.config import tr, settings, app_cfg
from phiendichvideo.task.taskcfg import InputFile, SignMsg
from phiendichvideo.util.help_misc import show_error, shutdown_system
...
class WinActionTaskMixin:
    ...
    def create_btns(self):
        ...
        if self.main.app_mode not in ['tiqu'] and len(self.obj_list) == 1:
            from phiendichvideo.task.only_one import Worker
            task = Worker(
                parent=self.main,
        ...
        from phiendichvideo.task.mult_video import MultVideo
    ...
    def update_data(self, uuid: Union[str, None] = "", d: Union[SignMsg, None] = None):
        ...
        if d['type'] == 'edit_dubbing':
            from phiendichvideo.component.onlyone_set_editdubb import EditDubbingResultDialog
        ...
        if d['type'] == 'edit_subtitle_source':
            from phiendichvideo.component.onlyone_set_recogn import EditRecognResultDialog
        ...
        if d['type'] == 'edit_recogn2_subtitle':
            from phiendichvideo.component.onlyone_set_recogn2 import EditRecognResultDialog2
        ...
        if d['type'] == 'edit_subtitle_target':
            from phiendichvideo.component.onlyone_set_role import SpeakerAssignmentDialog
